...
export function Full2DTab({ glbPath, initialGuidancePath }) {
    ...
    const segInputs = (_jsxs(_Fragment, { children: [_jsx(Field, { label: "GLB path", children: _jsx(TextInput, { id: "t-glb", placeholder: "Leave empty to use uploaded model", defaultValue: glbPath ?? '' }) }), _jsx(Field, { label: "Checkpoint (.ckpt)", children: _jsx(TextInput, { id: "t-ckpt", defaultValue: DEFAULT_CKPT }) }), _jsxs(Field, { label: "2D Guidance Map", children: [_jsxs("div", { className: "flex gap-2", children: [_jsx(TextInput, { ref: pathRef, placeholder: "Generate above or browse\u2026", value: guidancePath ?? '', onChange: e => setGuidancePath(e.target.value) }), _jsx("button", { onClick: pickGuidance, className: "px-3 py-2 bg-hover border border-border rounded-lg text-xs text-muted hover:text-white hover:border-accent transition-all whitespace-nowrap", children: "Browse" })] }), guidancePath && (_jsx("img", { ref: previewRef, src: fileUrl(guidancePath), className: "mt-2 rounded-lg border border-border max-h-20 object-contain bg-input", alt: "guidance preview" }))] })] }));
